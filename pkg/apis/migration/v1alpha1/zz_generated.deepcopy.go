...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MigIdentity) DeepCopyInto(out *MigIdentity) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MigIdentity.
func (in *MigIdentity) DeepCopy() *MigIdentity {
	if in == nil {
		return nil
	}
	out := new(MigIdentity)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MigIdentity) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MigIdentityList) DeepCopyInto(out *MigIdentityList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MigIdentityList.
func (in *MigIdentityList) DeepCopy() *MigIdentityList {
	if in == nil {
		return nil
	}
	out := new(MigIdentityList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MigIdentityList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MigIdentitySpec) DeepCopyInto(out *MigIdentitySpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MigIdentitySpec.
func (in *MigIdentitySpec) DeepCopy() *MigIdentitySpec {
	if in == nil {
		return nil
	}
	out := new(MigIdentitySpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MigIdentityStatus) DeepCopyInto(out *MigIdentityStatus) {
	*out = *in
	in.Conditions.DeepCopyInto(&out.Conditions)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MigIdentityStatus.
func (in *MigIdentityStatus) DeepCopy() *MigIdentityStatus {
	if in == nil {
		return nil
	}
	out := new(MigIdentityStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MigPlanSpec) DeepCopyInto(out *MigPlanSpec) {
	*out = *in
	...
	if in.SrcIdentityRef != nil {
		in, out := &in.SrcIdentityRef, &out.SrcIdentityRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	if in.DestIdentityRef != nil {
		in, out := &in.DestIdentityRef, &out.DestIdentityRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
	return
...
func (in *PlanResources) DeepCopyInto(out *PlanResources) {
	*out = *in
	...
	if in.SrcMigIdentity != nil {
		in, out := &in.SrcMigIdentity, &out.SrcMigIdentity
		*out = new(MigIdentity)
		(*in).DeepCopyInto(*out)
	}
	if in.DestMigIdentity != nil {
		in, out := &in.DestMigIdentity, &out.DestMigIdentity
		*out = new(MigIdentity)
		(*in).DeepCopyInto(*out)
	}
	return
